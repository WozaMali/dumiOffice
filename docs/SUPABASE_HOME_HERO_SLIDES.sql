...
values (
  'gift-edits-section',
  'Gift Edits',
  'Choose by recipient, mood, and presence.',
  true,
  940
)
on conflict (code) do update set
...
-- The Perfect Gift section header
insert into public.home_hero_slides (
  code, kicker, headline, subheadline, is_active, sort_order
)
values (
  ...
  'The Perfect Gift',
  'Everything they''ll remember — long after the ribbon comes off.',
  'A Dumi gift is not just fragrance. It is presence, presentation, and a quiet story told in scent.',
  true,
  934
)
on conflict (code) do update set
...
-- What every perfect gift includes
insert into public.home_hero_slides (
  code, headline, subheadline, primary_cta_label, primary_cta_href, is_active, sort_order
)
values
  (
    'gift-perfect-presence',
    'A scent that stays close',
    'Longevity and depth — so your gift is remembered at the end of the day, not just the opening.',
    null,
    null,
    true,
    951
  ...
  (
    ...
    'Elegant wrapping, considered weight, and a reveal worthy of birthdays, milestones, and thank-yous.',
    null,
    null,
    true,
    952
  ...
  (
    'gift-perfect-match',
    'Matched to who they are',
    'Chosen by character and mood — men''s strength, women''s grace, or a balanced scent for anyone.',
    null,
    null,
    true,
    953
  ...
  (
    ...
    'Their name, in gold',
    'Optional personalisation on the label — make it unmistakably theirs for an additional R20.',
    'Add personalisation',
    '/personalisation',
    true,
    954
  ...
  (
    'gift-perfect-heart',
    'Wrapped in Ubuntu',
    'Warmth, dignity, and connection — the feeling that someone chose this with real care.',
    null,
    null,
    true,
    955
...
-- Gift Guide feature bullets (legacy — optional)
insert into public.home_hero_slides (
  code, headline, subheadline, is_active, sort_order
)
values
  (
    'gift-guide-feature-presentation',
    'Presentation',
    'Elegant presentation that feels ready to give.',
    true,
    931
  ),
  (
    ...
    'Categories',
    'Clear gifting categories so choosing stays effortless.',
    true,
    932
  ),
  (
    ...
    'Premium tone',
    'A more premium tone for personal and corporate moments.',
    true,
    933
  )
on conflict (code) do update set
